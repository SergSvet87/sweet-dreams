...
import styles from './slider-arrows.module.css';
import classNames from 'classnames';

export default function SliderArrows() {
  return (
    <div className={styles.splide__arrows}>
      <button className={classNames(styles.splide__arrow, styles.splide__arrow_prev)}>
        <svg
          width="100"
          height="100"
          viewBox="0 0 100 100"
      ...
      <button className={classNames(styles.splide__arrow, styles.splide__arrow_next)}>
        <svg
          width="100"
          height="100"
          viewBox="0 0 100 100"
